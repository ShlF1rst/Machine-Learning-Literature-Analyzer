...
#	create_names_file('names/LotR/LOTR1.txt','1perceptron_model.sav','names_crf.txt')
#	test_crf()
#	CRF(data)
#	train_perceptron(data)
#	with codecs.open('names/LotR/LOTR1.txt',"r", 'utf_8_sig') as f:
#		text = f.read()
#	load_names('LotR',text)
#	with open('names/'+'LotR'+'/LOTR1.txt', 'r') as f:
#		text = f.read()
#	load_names('LotR',text)
